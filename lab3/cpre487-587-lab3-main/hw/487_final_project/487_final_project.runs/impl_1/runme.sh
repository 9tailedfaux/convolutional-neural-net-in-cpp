...
HD_PWD='/home/tjfriedl/Desktop/cpre_487/lab3/cpre487-587-lab3-main/hw/487_final_project/487_final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log redundant_adder_tree.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source redundant_adder_tree.tcl -notrace
